...
/*
Manages the network connectivity status and provides methods to check and 
...
class NetworkManager extends GetxController {
  ...
  /*
  Initialize the network manager and set up a stream to continually check the 
  connection status.
  */
  @override
  void onInit() {
  ...
  relevant popup for no internet connection.
  */
  Future<void> _updateConnectionStatus(List<ConnectivityResult> results) async {
    /*
    Assuming that if any of the connectivity results is not none, we are 
    connected 
    */
