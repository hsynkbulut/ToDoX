  ...
  String get message {
    switch (code) {
      case 'INVALID_LOGIN_CREDENTIALS':
        return '''
Geçersiz giriş bilgileri. Lütfen bilgilerinizi iki kez kontrol edin.''';
      case 'too-many-requests':
        return 'Çok fazla istek var. Lütfen daha sonra tekrar deneyin.';
      case 'invalid-argument':
        return '''
Kimlik doğrulama yöntemine geçersiz bağımsız değişken sağlandı.''';
      ...
      case 'operation-not-allowed':
        return '''
Oturum açma sağlayıcısı Firebase projeniz için devre dışı bırakıldı.''';
      case 'session-cookie-expired':
        return '''
Firebase oturum çerezinin süresi doldu. Lütfen tekrar giriş yapın.''';
      case 'uid-already-exists':
        return '''
Sağlanan kullanıcı kimliği zaten başka bir kullanıcı tarafından kullanılıyor.''';
      case 'sign_in_failed':
